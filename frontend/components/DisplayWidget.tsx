    ...
    <>
      <div className="flex mt-15 mr-2 flex-wrap px-10 justify-center mb-20">
        {widgets.map((item) => (
          <div
            key={item._id}
            className="relative flex flex-col my-6 shadow-xl/30 bg-gradient-to-b from-cyan-400 to-blue-500 shadow-sm border border-slate-200 rounded-lg w-70 mr-20 text-center"
          >
